...
import styles from './PucketsMatchModal.module.css'; // Import CSS module for styling
 ...
 */
const PucketsMatchModal: React.FC<PucketsMatchModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    <div className={`${styles.pucketsMatchModal} ${isOpen ? styles.pucketsMatchModalOpen : ''}`}>
      <div className={styles.modalContent}>
        ...
        <div className={styles.tabs}>
          ...
          {/* Tab: Record Match */}
          <button
            className={`${styles.tab} ${activeTab === 'Record Match' ? styles.tabActive : ''}`}
            onClick={() => handleTabChange('Record Match')}
          >
            Record Match
          </button>
        </div>
        ...
        <div className={styles.content}>
          ...
          {activeTab === 'Record Match' && <RecordMatch isOpen={isOpen} />}
        </div>
...
export default PucketsMatchModal;
